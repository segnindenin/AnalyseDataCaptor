...
# input_video = ffmpeg.input('./recording1.waw')

# input_audio = ffmpeg.input('./filename.mp4')

# ffmpeg.concat(input_video, input_audio, v=1, a=1).output().run()
...
class VideoRecorder():  
    ...
    def __init__(self, name="temp_video.avi", fourcc="MJPG", sizex=1080, sizey=1080, camindex=0, fps=25):
        self.open = True
...
def stop_AVrecording(filename="test"):
    ...
    clip = mpe.VideoFileClip("temp_video.avi" )
    w,z = clip.size
    print(w, z)
    audio_bg = mpe.AudioFileClip('temp_audio.wav')
    #final_audio = mpe.CompositeAudioClip(audio_bg)
    final_clip = clip.set_audio(audio_bg)
    final_clip.write_videofile('test.avi')
    # else:
