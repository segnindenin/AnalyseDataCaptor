...
data = data_df.drop((data_df.loc[(data_df['type_mesure'].isin([6,11])) & (data_df['phase'].isin([1,2,3]))].index) |
...
with open('r16_tab1_min_courant.pkl', "rb") as g:
    mcrt = pickle.load(g)
with open('r16_tab1_min_tension_n.pkl', "rb") as g:
    mten_n = pickle.load(g)
with open('r16_tab1_min_tension_ph.pkl', "rb") as g:
    mten_ph = pickle.load(g)
with open('r16_tab1_min_puissance_reactive.pkl', "rb") as g:
    mpui_rec = pickle.load(g)
with open('r16_tab1_min_puissance_active.pkl', "rb") as g:
    mpui_act = pickle.load(g)
...
data['unite_mesure'].loc[data['unite_mesure'].isin(['max_courant', 'min_courant', '', ''])] = 'A'
data['unite_mesure'].loc[data['unite_mesure'].isin(['max_tension_n', 'min_tension_n', 'max_tension_ph', 'min_tension_ph'])] = 'V'
